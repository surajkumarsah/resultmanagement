...
function fire_ajax_save_school(record) {

    //let record = w2ui['myForm'].record;
    
    var jsonSchoolData = {};
    jsonSchoolData.schoolId = record.schoolId;
    jsonSchoolData.schoolName = record.schoolName;
    jsonSchoolData.schoolEmail = record.schoolEmail;
    jsonSchoolData.schoolDesc = record.schoolDesc;
	...
	jsonSchoolData.addressId = jsonAddressData;

    var jsonSchoolDataString = JSON.stringify(jsonSchoolData)
 ...
 $('#toolbar').w2toolbar({
    ...
    items: [
		...
		{ type: 'button', id: 'users', text: 'Users', icon: 'w2ui-icon-check' },
