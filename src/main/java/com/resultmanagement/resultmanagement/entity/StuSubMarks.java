...
@Entity
public class StuSubMarks {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "stu_sub_marks_id")
	...
	public StuSubMarks(Integer stuSubMarksId, Integer schoolId, Integer studentId, Integer subjectId, Integer marks,
